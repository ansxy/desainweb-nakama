export default function Footer(){
    return(
        <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 items-center p-8 justify-items-center">
            ...
            <div className="flex justify-center items-center p-5 text-xs">
